...
Donate link: https://2code.info/plugins/WPQA/
...
The plugin main page : https://2code.info/plugins/WPQA/
...
== Installation ==
Installing "WPQA" can be done either by searching for "WPQA" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
...
just see this demo :
https://2code.info/plugins/WPQA/demo