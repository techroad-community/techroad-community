...
function discy_admin_meta() {
	...
	if (discy_is_post_type(array("page"))) {
		...
		$options[] = array(
			'div'       => 'div',
			'condition' => prefix_meta.'home_tabs:has(recent-questions),'.prefix_meta.'home_tabs:has(most-answers),'.prefix_meta.'home_tabs:has(question-bump),'.prefix_meta.'home_tabs:has(new-questions),'.prefix_meta.'home_tabs:has(sticky-questions),'.prefix_meta.'home_tabs:has(polls),'.prefix_meta.'home_tabs:has(most-visit),'.prefix_meta.'home_tabs:has(most-vote),'.prefix_meta.'home_tabs:has(random),'.prefix_meta.'home_tabs:has(no-answers),'.prefix_meta.'home_tabs:has(recent-questions-2),'.prefix_meta.'home_tabs:has(most-answers-2),'.prefix_meta.'home_tabs:has(question-bump-2),'.prefix_meta.'home_tabs:has(new-questions-2),'.prefix_meta.'home_tabs:has(sticky-questions-2),'.prefix_meta.'home_tabs:has(polls-2),'.prefix_meta.'home_tabs:has(most-visit-2),'.prefix_meta.'home_tabs:has(most-vote-2),'.prefix_meta.'home_tabs:has(random-2),'.prefix_meta.'home_tabs:has(no-answers-2)',
			'operator'  => 'or',
			'type'      => 'heading-2'
		);
		...
		$options[] = array(
			'div'       => 'div',
			'condition' => prefix_meta.'home_tabs:has(answers),'.prefix_meta.'home_tabs:has(answers-2)',
			'operator'  => 'or',
			'type'      => 'heading-2'
		);
