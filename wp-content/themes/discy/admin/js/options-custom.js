			...
			jQuery('.discy_framework .sort-sections').each(function () {
				if (!jQuery(this).hasClass("not-sort") && jQuery(this).hasClass("sort-sections-with")) {
					jQuery(this).sortable({
						...
						cancel: ".builder-toggle-open,.builder-toggle-close,.builder_clone,.del-builder-item,.switch",
		...
		container.find('.section .sort-sections').each(function() {
		   var t = this;
			...
			if (!jQuery(t).hasClass("not-sort") && !jQuery(t).hasClass("sort-sections-with")) {
				jQuery(t).sortable({placeholder: "ui-state-highlight",handle: ".widget-head,.widget-handle",cancel: ".builder-toggle-open,.builder-toggle-close,.builder_clone,.del-builder-item,.switch"});
			}
		});
