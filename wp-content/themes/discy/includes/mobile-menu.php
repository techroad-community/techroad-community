				...
				<?php if ($active_mobile_menu == "on") {
					...
					if ($sidebar_where == "menu_sidebar" || $sidebar_where == "menu_left") {
						...
						<div class="mobile-menu-left">
							<?php wp_nav_menu(array('container' => '','container_class' => 'nav_menu','menu_id' => 'nav_menu',($left_menu_s != ""?"menu":"theme_location") => ($left_menu_s != "" && $left_menu_s != 0?$left_menu_s:$left_menu),'fallback_cb' => 'discy_nav_fallback'));?>
