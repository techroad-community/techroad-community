			...
			if (isset($first_one)) {?>
				<div class="col <?php echo (isset($options_categories) && is_array($options_categories) && $categories_filter == "on"?"col9":"col12")?>">
					<div class="wrap-tabs">
						<div class="menu-tabs">
							<ul class="menu flex">
								<?php discy_home_tabs($discy_home_tabs,$first_one,(isset($category_id) && $category_id > 0?$category_id:0));?>
							</ul>
						</div><!-- End menu-tabs -->
					</div><!-- End wrap-tabs -->
				</div><!-- End col9 -->
...
if (empty($_GET["show"])) {
	...
	if (isset($wp_page_template) && $wp_page_template == "template-home.php" && isset($first_one)) {
	...
	if (isset($first_one) && (($first_one == $answers_slug && isset($discy_home_tabs["answers"]["value"]) && $discy_home_tabs["answers"]["value"] != "" && $discy_home_tabs["answers"]["value"] != "0") || ($first_one == $answers_slug_2 && isset($discy_home_tabs["answers-2"]["value"]) && $discy_home_tabs["answers-2"]["value"] != "" && $discy_home_tabs["answers-2"]["value"] != "0"))) {
		$get_loop = true;
	}else if (isset($first_one) && (($first_one == $recent_questions_slug && isset($discy_home_tabs["recent-questions"]["value"]) && $discy_home_tabs["recent-questions"]["value"] != "" && $discy_home_tabs["recent-questions"]["value"] != "0") || ($first_one == $most_answers_slug && isset($discy_home_tabs["most-answers"]["value"]) && $discy_home_tabs["most-answers"]["value"] != "" && $discy_home_tabs["most-answers"]["value"] != "0") || ($first_one == $no_answers_slug && isset($discy_home_tabs["no-answers"]["value"]) && $discy_home_tabs["no-answers"]["value"] != "" && $discy_home_tabs["no-answers"]["value"] != "0") || ($first_one == $most_visit_slug && isset($discy_home_tabs["most-visit"]["value"]) && $discy_home_tabs["most-visit"]["value"] != "" && $discy_home_tabs["most-visit"]["value"] != "0") || ($first_one == $most_vote_slug && isset($discy_home_tabs["most-vote"]["value"]) && $discy_home_tabs["most-vote"]["value"] != "" && $discy_home_tabs["most-vote"]["value"] != "0") || ($first_one == $random_slug && isset($discy_home_tabs["random"]["value"]) && $discy_home_tabs["random"]["value"] != "" && $discy_home_tabs["random"]["value"] != "0") || ($first_one == $question_new_slug && isset($discy_home_tabs["new-questions"]["value"]) && $discy_home_tabs["new-questions"]["value"] != "" && $discy_home_tabs["new-questions"]["value"] != "0") || ($first_one == $question_sticky_slug && isset($discy_home_tabs["sticky-questions"]["value"]) && $discy_home_tabs["sticky-questions"]["value"] != "" && $discy_home_tabs["sticky-questions"]["value"] != "0") || ($first_one == $question_polls_slug && isset($discy_home_tabs["polls"]["value"]) && $discy_home_tabs["polls"]["value"] != "" && $discy_home_tabs["polls"]["value"] != "0") || ($first_one == $recent_posts_slug && isset($discy_home_tabs["recent-posts"]["value"]) && $discy_home_tabs["recent-posts"]["value"] != "" && $discy_home_tabs["recent-posts"]["value"] != "0") || ($first_one == $posts_visited_slug && isset($discy_home_tabs["posts-visited"]["value"]) && $discy_home_tabs["posts-visited"]["value"] != "" && $discy_home_tabs["posts-visited"]["value"] != "0") || ($question_bump == "on" && $active_points == "on" && $first_one == $question_bump_slug && isset($discy_home_tabs["question-bump"]["value"]) && $discy_home_tabs["question-bump"]["value"] != "" && $discy_home_tabs["question-bump"]["value"] != "0") || ($first_one == $recent_questions_slug_2 && isset($discy_home_tabs["recent-questions-2"]["value"]) && $discy_home_tabs["recent-questions-2"]["value"] != "" && $discy_home_tabs["recent-questions-2"]["value"] != "0") || ($first_one == $most_answers_slug_2 && isset($discy_home_tabs["most-answers-2"]["value"]) && $discy_home_tabs["most-answers-2"]["value"] != "" && $discy_home_tabs["most-answers-2"]["value"] != "0") || ($first_one == $no_answers_slug_2 && isset($discy_home_tabs["no-answers-2"]["value"]) && $discy_home_tabs["no-answers-2"]["value"] != "" && $discy_home_tabs["no-answers-2"]["value"] != "0") || ($first_one == $most_visit_slug_2 && isset($discy_home_tabs["most-visit-2"]["value"]) && $discy_home_tabs["most-visit-2"]["value"] != "" && $discy_home_tabs["most-visit-2"]["value"] != "0") || ($first_one == $most_vote_slug_2 && isset($discy_home_tabs["most-vote-2"]["value"]) && $discy_home_tabs["most-vote-2"]["value"] != "" && $discy_home_tabs["most-vote-2"]["value"] != "0") || ($first_one == $random_slug_2 && isset($discy_home_tabs["random-2"]["value"]) && $discy_home_tabs["random-2"]["value"] != "" && $discy_home_tabs["random-2"]["value"] != "0") || ($first_one == $question_new_slug_2 && isset($discy_home_tabs["new-questions-2"]["value"]) && $discy_home_tabs["new-questions-2"]["value"] != "" && $discy_home_tabs["new-questions-2"]["value"] != "0") || ($first_one == $question_sticky_slug_2 && isset($discy_home_tabs["sticky-questions-2"]["value"]) && $discy_home_tabs["sticky-questions-2"]["value"] != "" && $discy_home_tabs["sticky-questions-2"]["value"] != "0") || ($first_one == $question_polls_slug_2 && isset($discy_home_tabs["polls-2"]["value"]) && $discy_home_tabs["polls-2"]["value"] != "" && $discy_home_tabs["polls-2"]["value"] != "0") || ($first_one == $recent_posts_slug_2 && isset($discy_home_tabs["recent-posts-2"]["value"]) && $discy_home_tabs["recent-posts-2"]["value"] != "" && $discy_home_tabs["recent-posts-2"]["value"] != "0") || ($first_one == $posts_visited_slug_2 && isset($discy_home_tabs["posts-visited-2"]["value"]) && $discy_home_tabs["posts-visited-2"]["value"] != "" && $discy_home_tabs["posts-visited-2"]["value"] != "0") || ($question_bump == "on" && $active_points == "on" && $first_one == $question_bump_slug_2 && isset($discy_home_tabs["question-bump-2"]["value"]) && $discy_home_tabs["question-bump-2"]["value"] != "" && $discy_home_tabs["question-bump-2"]["value"] != "0"))) {
		$get_loop = true;
